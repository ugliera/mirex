...
lyr_etablissement_france_entire_github_1.set('fieldLabels', {'REG_LIBENR': 'inline label', 'DEP': 'no label', 'UAI_DENOMP': 'no label', 'NAT_LIB': 'no label', 'UAI_DENO_1': 'inline label', 'UAI_INDEXA': 'inline label', 'UAI_RNE_RF': 'no label', 'UAI_TEL_LB': 'inline label', 'UAI_ADRINT': 'no label', 'SECT_LIBCO': 'inline label', });
